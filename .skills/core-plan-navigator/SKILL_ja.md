---
name: plan-navigator
description: AIの「Planモード」に論理的な羅針盤を与え、短絡的な回答を防いで本質的な解決策へと導く思考ナビゲーター。特に「実行 / スペシャリスト」ロールにおいて、深い推論を導くために使用されます。
---
...
| ワークフロー | Plan Navigator の役割 | 主なユーザー |
| :--- | :--- | :--- |
| **SDE** | `doc-coauthoring` からの高度な仕様を、5段階の実行戦略に変換。 | **Implementation** |
| **反復的検証** | 論理的な反復により、現状と理想の成果物のギャップを埋める。 | **Implementation** |
